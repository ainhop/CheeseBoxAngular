  ...
  ngOnInit(): void {
    let sub = this.activateRoute.params.subscribe(async (params: Params) => {
      ...
      this.formulario = new FormGroup({
        ...
        quesoUtilizado: new FormControl(this.receta.quesoUtilizado, [
          Validators.required,
          Validators.minLength(2),
        ]),
        ingredientes: new FormControl(this.receta.ingredientes, [
          Validators.required,
          Validators.minLength(2),
        ]),
        tiempo: new FormControl(this.receta.tiempo, [
          Validators.required,
          Validators.minLength(2),
        ]),
        raciones: new FormControl(this.receta.raciones, [
          Validators.required,
          Validators.minLength(2),
        ]),
        elaboracion: new FormControl(this.receta.elaboracion, [
          Validators.required,
          Validators.minLength(2),
        ]),
      });
